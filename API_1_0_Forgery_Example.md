The forgery script requires java to be installed, and requires to paste a copy of the createSod.jar from the genpassport module on the same directory that your forgery python script. The archive can be found in the genpassport directory of the pypassport API.
